...
const Header = () => {
    ...
    <>
      <header className={`fixed top-0 w-full z-50 transition-all duration-500`}>
        <div className="flex items-center justify-between px-30 py-3 bg-transparent">
          ...
          <nav className={`flex items-center space-x-6 transition-all duration-[1000ms] ease-in-out ${isScrolled ? "translate-x-28" : ""}`}>
  {/* Main Menu */}
  <div
    ref={navRef}
  ...
  >
    <span
      className={isCollapsed ? "hidden" : `absolute top-1 bottom-1 rounded-full bg-[#D0F94A] text-black transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden`}
      style={{
        left: indicator.left,
              ...
              <div className="px-6">
                ...
                <ul className="text-[16px] font-[600] space-y-2">
                  <div>
                    ...
                    <p className="text-[14px]  font-[400]">Edge intelligence for every creator</p>
                  </div>
                  <div>
                    <li>LLM Solutions</li>
                    <p className="text-[14px] font-[400]">Edge intelligence for every creator</p>
