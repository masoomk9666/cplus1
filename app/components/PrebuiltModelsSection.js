...
const cards = [
  { title: "Meeting Point Collection",
    ...
    backDescription: "An AI-powered system that identifies and collects meeting points from images or videos, enhancing location-based services and navigation applications."
   },
  { title: "Body Tracking System",
    imgSrc: "/images/preBuiltModelsSection/02.png",
    backTitle: "Body Tracking System",
    backDescription: "An advanced AI model that accurately tracks human body movements in real-time, enabling applications in fitness, gaming, and augmented reality."

   },
  { title: "Roof Detection System",
    imgSrc: "/images/preBuiltModelsSection/03.png",
    backTitle: "Roof Detection System",
    backDescription: "An AI-driven solution that detects and analyzes roof structures from aerial imagery, assisting in urban planning, construction, and real estate assessments."
   },
  { title: "Voice Classification System",
    imgSrc: "/images/preBuiltModelsSection/04.png",
    backTitle: "Voice Classification System",
    backDescription: "A sophisticated AI model that classifies and categorizes voice inputs, enhancing applications in customer service, security, and voice-activated technologies."
   },
  { title: "Human Activity Recognition",
    imgSrc: "/images/preBuiltModelsSection/05.png",
    backTitle: "Human Activity Recognition",
    backDescription: "An AI model that identifies and interprets human activities from video data, enabling applications in surveillance, healthcare, and sports analytics."
   },
  { title: "PDF Fields Extraction",
    imgSrc: "/images/preBuiltModelsSection/06.png",
    backTitle: "PDF Fields Extraction",
    backDescription: "An AI-powered tool that extracts and organizes fields from PDF documents, streamlining data entry and document management processes."
  },
  { title: "Facial Expression Detection",
    imgSrc: "/images/preBuiltModelsSection/07.png",
    backTitle: "Facial Expression Detection",     
    backDescription: "An AI model that detects and interprets facial expressions, enabling applications in emotion analysis, user experience research, and human-computer interaction."
  },
  { title: "Human Counting System",
    imgSrc: "/images/preBuiltModelsSection/08.png",
    backTitle: "Human Counting System",
    backDescription: "An AI-driven solution that accurately counts the number of individuals in a given area, useful for crowd management, retail analytics, and event planning."
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 ml-25">
  {cards.map((card, index) => (
    <div
      key={index}
      className={`relative p-2 h-80 rounded-2xl backdrop-blur-lg bg-white/40 
        border border-white/50 shadow-lg overflow-hidden
        ${index % 4 === 0 ? "mt-0" : ""}
        ${index % 4 === 1 ? "-mt-20" : ""}
        ${index % 4 === 2 ? "-mt-40" : ""}
        ${index % 4 === 3 ? "-mt-60" : ""}
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 ml-25 perspective-[1200px]">
  {cards.map((card, index) => (
    <div
      key={index}
    ...
    >
      ...
      <div className="relative w-full h-full transition-transform duration-700 ease-in-out
        ...
        {/* ================= FRONT ================= */}
        <div className="absolute inset-0 p-2 rounded-2xl backdrop-blur-lg bg-white/20
        ...
        {/* ================= BACK ================= */}
        <div className="absolute inset-0 p-2 rounded-2xl bg-wghite/20
           shadow-lg overflow-hidden
