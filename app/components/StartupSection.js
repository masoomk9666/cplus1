    ...
    <section className="w-full max-w-7xl  py-25">
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {cardsData.map((card) => (
          <div
            key={card.id}
            className="relative rounded-2xl overflow-hidden min-h-[350px] p-3"
            style={{
          ...
          >
            <div className="relative z-10 p-6 text-white">
              <h3 className="text-[24px] font-[400] mb-3">
                {card.title}
              </h3>

              <p className="text-[16px] text-gray-200 mb-2 leading-relaxed">
                {card.description}
              </p>
              <p className="text-[16px] text-gray-200 mb-2">Includes:</p>

              <ul className="list-disc list-inside space-y-1 text-[16px] ml-3 text-gray-200">
      ...
      <div className="mt-30">
        <img src="images/startup/animation.png" alt="Startup Discovery" className="w-full h-full object-cover rounded-2xl" /> 
      </div>
    </section>
  );
}
