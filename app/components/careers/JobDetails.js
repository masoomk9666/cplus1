...
//         variants={fadeUp}
//         custom={0}
//         className="text-[16px] tracking-widest text-black text-center"
//       >
...
//         variants={fadeUp}
//         custom={1}
//         className="text-[48px] font-medium text-center mt-2"
//       >
//         {job.title}
//       </motion.h1>
...
//         variants={fadeUp}
//         custom={2}
//         className="text-[18px] text-black text-center mt-2"
//       >
//         {job.type}
//       </motion.p>
...
//           initial="hidden"
//           animate="visible"
//           className="relative bg-[#FBFBFB] rounded-2xl p-8 mt-10 overflow-hidden"
//         >
//           {/* Absolute centered background image */}
//           <div
//             className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-cover bg-center"
...
//               variants={fadeUp}
//               custom={i + 2}
//               className="text-black text-[18px] mt-3"
//             >
//               {para}
//             </motion.p>
//           ))}
...
//             variants={fadeUp}
//             custom={5}
//             className="font-medium text-[32px] mt-8"
//           >
//             Requirements
//           </motion.h3>
...
//                 variants={fadeUp}
//                 custom={i + 11}
//                 className="text-black text-[18px] ml-3"
//               >
//                 {item}
//               </motion.li>
//             ))}
...
//         </motion.div>
//       )}
//       {activeTab === "application" && <Application fadeUp={fadeUp} />}
//     </motion.section>
//   );
// }
    ...
    >
      ...
      >
        {[
          ...
          <div
            key={tab.id}
            className={`rounded-full p-[1px] sm:p-[2px] transition-all duration-300  ${
              activeTab === tab.id
                ? "bg-gradient-to-b from-[#D0F94A] to-[#00879F]"
                : "bg-transparent"
            }`}
          >
            <button
              onClick={() => setActiveTab(tab.id)}
              className={`px-4 sm:px-5 md:px-6 py-1.5 sm:py-2 rounded-full w-full transition-all duration-300 text-[14px] sm:text-[15px] md:text-[16px] cursor-pointer ${
                activeTab === tab.id
                  ? "bg-black text-white"
                  : "bg-gray-200 text-gray-700"
              }`}
