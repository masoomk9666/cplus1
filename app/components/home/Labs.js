          ...
          <div className="group relative rounded-xl md:rounded-2xl p-6 sm:p-8 md:p-10 min-h-[400px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[600px] bg-gradient-to-r from-[#AEDBC9] to-[#DDF6E4] overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[14px] sm:text-[15px] md:text-[16px] text-black mt-2 sm:mt-3 leading-relaxed">
                Our Artificial Intelligence Lab is where innovation meets real-world impact. We design, train, and deploy intelligent systems that transform data into actionable insights.
              </p>
              ...
              <p className="text-[14px] sm:text-[15px] md:text-[16px] text-black mt-2 leading-relaxed hidden sm:block">
                From machine learning models to advanced automation and predictive analytics, we help businesses unlock smarter decision-making, optimize operations, and build future-ready digital products powered by AI.
              </p>
